  ...
  return (
    <div className="xl:pb-[11.6rem] xl:w-full xl-h-full">
      ...
      <div className="xl:flex xl:justify-start">
        <div className="flex absolute xl:w-2/3">
          <img
        ...
        <div className="relative top-[-1.5rem] left-[3.5rem] py-[1.44rem] pl-[1.62rem] pr-[0.69rem] w-[17.6875rem] border border-[#F4DE88] bg-[#000] xl:top-[4rem] xl:left-[50%] xl:max-h-[20rem] xl:min-w-[25rem] 2xl:left-[50rem] 2xl:top-20 2xl:min-h-[25rem] 2xl:min-w-[39rem] ">
          <TextLight>
